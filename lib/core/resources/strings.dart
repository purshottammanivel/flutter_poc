class Strings {
  ...
  static const String appTitle = "Uno Point POC";
  static const String appName = 'UnoPoint';
  static const String appDescriptionPrefix = 'Hello !';
  static const String appDescriptionSuffix =
      'organize your\nfield management\nhere..';
  static const String appVersion = 'version 112.1';
  static const String btnTextNext = 'Next';
  static const String termsAndConditions = "\n" +
      "Privacy Policy\n" +
      "General:\n" +
      "\n" +
      "At Intelliuno Technology Solution LLP, we respect your need for online privacy and protect any Personal Information that you may share with us, in an appropriate manner. Our practice with respect to use of your Personal Information is as set forth below in this Privacy Policy Statement. As a condition to use our Services, you consent to the terms of the Privacy Policy Statement as it may be updated from time to time. This Privacy Policy Statement applies exclusively to https://intelli.uno/privacy-policy.html\n" +
      "\n" +
      "If you have questions or complaints regarding our privacy policy or practices, please contact us via email at support@intelli.uno\n" +
